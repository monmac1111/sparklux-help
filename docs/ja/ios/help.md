...
| フレーム補間 | 動きを滑らかにします（30fps 以下の動画）。最初からオンです（画質の設定で切れます）。効いているときは画面上に「滑らか ×2」と出ます。効かないときは理由が出ます |
| 音声と字幕 | 音声トラック・字幕を選べます |
| いまの状態 | 明るさの余力（普通の白の何倍まで明るくできるか。例: ×8.0）・元の解像度・表示の解像度 |

**フレーム補間が使える動画**

- **720p 以下・8bit**: 軽い方式で、どの対応端末でも使えます
- **1080p・10bit**: 端末で速さを測ってから使います。iPhone 17 Pro Max では **1080p の 24fps まで**使えます
- **30fps を超える動画・1440p 以上**は使えません（1080p の 30fps も間に合いません）。そのときは理由が出ます
