...
| 操作 | 動き |
|---|---|
| 真ん中を 1 回タップ | 操作バーが出ていないとき: 再生 / 一時停止（止めている間は操作バーが出たままになります）。操作バーが出ているとき: 操作バーを隠すだけ（再生 / 一時停止はしません） |
...
**操作バー**には、シークバー・10 秒戻る / 進むボタン・再生 / 一時停止・✨（画質）・×（閉じる）があります。拡大中は倍率のボタン（押すと等倍）も出ます。拡大しても、アップスケールと超解像は画面に出ている範囲に対して効きます。
